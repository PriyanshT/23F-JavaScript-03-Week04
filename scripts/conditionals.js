...
var homeWorkDone = 1;
var coffeeBreak;
if (homeWorkDone === true) { // true/false // == and ===
    // what we what to do if the condition occurs
    coffeeBreak = 20;
} else {
    // what to do if the condition does not satisfy
    coffeeBreak = 1;
}
...
coffeeBreak ? breakMessage.textContent = "Yea, it's coffee time." : breakMessage.textContent = "Oh no! I want a coffee.";
